...
(function(){
  ...
  function hideColorLegend(){
    const candidates=[...document.querySelectorAll('body *')].filter(el=>{
      ...
      return t==='cores dos cartões:' || t==='cores dos cartoes:';
    });
    candidates.forEach(el=>{
      ...
      for(let i=0;i<5 && p;i++,p=p.parentElement){
        ...
        if(r.width>100 && r.width<450 && r.height>30 && r.height<350 && txt.includes('liberado') && txt.includes('parado') && txt.includes('pronto')){
