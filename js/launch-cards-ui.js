...
(function(){
  ...
  function ensureBlueStatusCss(){
    ...
    const s=document.createElement('style');s.id='falta-acertar-blue-css-v3';s.textContent=`
      .launch.payment-falta-acertar,.grouped-service.payment-falta-acertar,.service-card.payment-falta-acertar{background:#1476e8!important;color:#fff!important;border:2px solid #075fc5!important;box-shadow:0 6px 18px rgba(20,118,232,.30)!important}
      ...
      .launch.payment-falta-acertar .chips .chip,.launch.payment-falta-acertar .chips .chip *{color:#111827!important;-webkit-text-fill-color:#111827!important;text-shadow:none!important}
      .launch.payment-falta-acertar .chips .chip{background:#e6f7ef!important;border-color:#d1eadf!important}
      .grouped-service.payment-falta-acertar .grouped-items .grouped-item,.grouped-service.payment-falta-acertar .grouped-items .grouped-item *{color:#111827!important;-webkit-text-fill-color:#111827!important;text-shadow:none!important}
