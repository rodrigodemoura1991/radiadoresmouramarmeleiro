...
(function(){
  ...
  function ensureServicesCss(){
    ...
    const link=document.createElement('link');link.id='todos-servicos-ui-css';link.rel='stylesheet';link.href='css/todos-servicos-ui.css?v=20260826-1131';document.head.appendChild(link);
  }
